...
export default function UpdateLotteryGame() {
  ...
  return (
    <>
      ...
      <main className="flex-1 p-8 overflow-auto">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">UPDATE LOTTERY GAMES</h2>
        
        <Card className="shadow-xl border-0 p-6">
          <CardContent className="p-0 grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Select>
                  <SelectTrigger id="game-type" className="bg-gray-50 border-gray-200 rounded-lg">
              ...
              <div>
                ...
                <Select>
                  <SelectTrigger id="game-platform" className="bg-gray-50 border-gray-200 rounded-lg">
          ...
          <div className="mt-8 pt-6 border-t border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
              <div>
                ...
                <Select>
                  <SelectTrigger id="winning-type" className="bg-gray-50 border-gray-200 rounded-lg">
              ...
              <div>
                ...
                <div className="flex items-center">
                  ...
                  <span className="bg-gray-200 text-gray-700 px-3 py-2 rounded-r-lg border border-gray-200 border-l-0">%</span>
                </div>
              </div>
              <div>
